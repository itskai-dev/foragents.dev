...
export default async function MetricsGuidePage() {
  const guides = (await readObservabilityGuides()).filter((guide) => guide.category === "metrics");
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <h1 className="text-4xl font-bold">Metrics for Agent Reliability and Cost</h1>
      </div>
